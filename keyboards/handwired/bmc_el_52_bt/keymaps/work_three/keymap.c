...
//                              `--------------------'`--------------------'
    ...
    KC_LSHIFT    ,KC_Z,             KC_X,   KC_C,   KC_V,        KC_B,                                   KC_N,        KC_M,        KC_COMM,KC_DOT, KC_SLSH,MT(MOD_RSFT, KC_ENT), \
                                                    ALT_T(KC_F2),CTL_T(KC_SPC),LT(1,KC_SPC),LT(1,KC_SPC),LT(2,KC_SPC),LCTL(KC_F2)                                  \
),
//  KC_LSHIFT    ,
//   OR
//  MT(MOD_LSFT,KC_CAPSLOCK),
...
//                              `--------------------'`--------------------'
    ...
    _______,      XXXXXXX,          XXXXXXX,XXXXXXX,XXXXXXX,     XXXXXXX,                                KC_ASTR,     KC_7,        KC_8,   KC_9,   KC_MINS,KC_BSPC, \
...
//                              `--------------------'`--------------------'
    ...
    _______,      KC_GRV,           KC_LCBR,KC_RCBR,KC_PIPE,     KC_PGUP,                                XXXXXXX,     KC_DEL,      XXXXXXX,KC_BSPC,KC_MINS,KC_BSPC, \
