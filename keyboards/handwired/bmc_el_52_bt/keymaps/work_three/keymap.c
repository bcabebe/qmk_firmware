...
//                              |      | Ctrl |  LY1 ||  LY1 |  LY2 | Alt  |
//                              `--------------------'`--------------------'
                  KC_F11,           KC_F12, KC_F3,  XXXXXXX,    XXXXXXX,                                 XXXXXXX,     KC_PGUP,     KC_PGDN,KC_PAUS,KC_PSCR,         \
    _______,      KC_GRV,           KC_LCBR,KC_RCBR,KC_PIPE,    XXXXXXX,                                 KC_ASTR,     KC_DEL,      KC_SLCK,KC_BSPC,KC_PLUS,KC_BSPC, \
    _______,      KC_TILD,          KC_LBRC,KC_RBRC,XXXXXXX,    KC_0,                                    KC_1,        KC_LEFT,     KC_UP  ,KC_RGHT,KC_EQL, KC_INS,  \
    _______,      XXXXXXX,          XXXXXXX,XXXXXXX,XXXXXXX,    XXXXXXX,                                 KC_0,        KC_HOME,     KC_DOWN,KC_END, KC_BSLS,_______, \
                                                    _______,    _______,      _______,      _______,     _______,     _______                                       \
),
};
