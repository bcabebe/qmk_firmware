...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {                  // make 1,2,3,= tap parenthesis for extra thumb buttons, (,[,{,},],)
[0] = KEYMAP( /* Base */
                  KC_1,             KC_2,   KC_3,   KC_4,   KC_5,                                     KC_6,        KC_7,   KC_8,   KC_9,   KC_0,            \
                  KC_Q,             KC_W,   KC_E,   KC_R,   KC_T,          ALT_T(KC_DEL),LT(1,KC_INS),KC_Y,        KC_U,   KC_I,   KC_O,   KC_P,            \
    ...
    OSM(MOD_LSFT),                                  KC_LBRC,CTL_T(KC_MINS),                           LT(2,KC_SPC),KC_RBRC,                        MT(MOD_RSFT, KC_ENT) \
),
[1] = KEYMAP( /* All Other keys */
                  KC_F1,            KC_F2,  KC_F3,  KC_F4,  KC_F5,                                    KC_F6,       KC_F7,  KC_F8,  KC_F9,  KC_F10,         \
                  KC_GRV,           KC_LCBR,KC_RCBR,KC_PIPE,KC_SLSH,       _______,      _______,     KC_ASTR,     KC_7,   KC_8,   KC_9,   KC_MINS,        \
    _______,      KC_TILD,          KC_LBRC,KC_RBRC,KC_BSLS,KC_PGUP,                                  KC_SLSH,     KC_4,   KC_5,   KC_6,   KC_PLUS,KC_F11, \
    _______,      DOUBLE_ZERO_MACRO,KC_INS, KC_HOME,KC_END, KC_PGDN,                                  KC_0,        KC_1,   KC_2,   KC_3,   KC_EQL, KC_F12, \
    _______,                                        _______,_______,                                  _______,     _______,                        _______ \
),
[2] = KEYMAP( /* Arrow Keys */
                  XXXXXXX,          XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,                                  XXXXXXX,     XXXXXXX,KC_PGUP,XXXXXXX,XXXXXXX,         \
                  XXXXXXX,          XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,       _______,      _______,     KC_INS,      XXXXXXX,KC_PGDN,XXXXXXX,XXXXXXX,         \
    _______,      XXXXXXX,          XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,                                  KC_HOME,     KC_LEFT,KC_UP  ,KC_RGHT,KC_PGUP,XXXXXXX, \
    _______,      XXXXXXX,          XXXXXXX,KC_PSCR,XXXXXXX,XXXXXXX,                                  KC_END ,     XXXXXXX,KC_DOWN,XXXXXXX,KC_PGDN,XXXXXXX, \
