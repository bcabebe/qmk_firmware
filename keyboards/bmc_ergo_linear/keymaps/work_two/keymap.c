...
//                              `--------------------'`--------------------'
    ...
    OSM(MOD_LSFT),                                  KC_F2,  CTL_T(KC_SPC),                          LT(2,KC_SPC),LCTL(KC_F2),                        MT(MOD_RSFT,KC_ENT) \
),
...
//                              `--------------------'`--------------------'
    ...
    _______,      KC_BSPC,          KC_LEFT,KC_UP,  KC_RGHT,KC_MINS,                                KC_SLSH,     KC_4,       KC_5,   KC_6,   KC_MINS,_______, \
...
//                              `--------------------'`--------------------'
                  ...
                  KC_GRV,           KC_LCBR,KC_RCBR,KC_PIPE,KC_PGUP,      _______,     _______,     XXXXXXX,     KC_DEL,     XXXXXXX,XXXXXXX,KC_PLUS,         \
    _______,      KC_TILD,          KC_LBRC,KC_RBRC,XXXXXXX,KC_0,                                   KC_1,        KC_LEFT,    KC_UP  ,KC_RGHT,KC_MINS,_______, \
