...
//                              `--------------------'`--------------------'
    ...
    _______,      KC_INS,           KC_LEFT,KC_UP,  KC_RGHT,     KC_MINS,                                 KC_SLSH,     KC_4,       KC_5,   KC_6,   KC_EQL, KC_BSPC, \
    _______,      DOUBLE_ZERO_MACRO,KC_DEL, KC_DOWN,KC_BSPC,     LCTL(KC_F2),                             KC_0,        KC_1,       KC_2,   KC_3,   XXXXXXX,XXXXXXX, \
